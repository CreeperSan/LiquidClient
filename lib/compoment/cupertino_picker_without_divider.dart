...
///
///  FlutterSDK中提供的 iOS风格的选择器 Widget，这里把SDK中的代码复制了一份并去除了下划线
///
///  此文件的内容源自 Flutter 1.22.4 Stable SDK 中的iOS风格选择器
///  路径为 flutter/src/cupertino/picker.dart
///  这里对源文件复制了一份，并去除了选择器中固定展示的分割线，因为源码中并不支持对分割线进行隐藏，
///  因此根据Github上官方对相同issue的回复建议是，重新复制一份并进行修改，链接如下
///
///  https://github.com/flutter/flutter/issues/57737
///
///  因此，就这么做了。如果后续此文件出现问题，可以从FlutterSDK中重新拷贝一份并做相应修改就好
///  当时主要修改内容如下：
///    1. 修改 colors.dart 和 theme.dart 的导包路径
///    2. 删除 _buildMagnifierScreen() 方法以及引用，此方法是用于绘制分割线的
///
